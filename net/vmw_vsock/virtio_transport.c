...
/* Caller needs to be holding mutex lock on vsock->tx_lock */
...
virtio_transport_send_pkt(struct sk_buff *skb)
{
	...
	/* If the intermediate queue is empty, we can try to directly send
	 * the packet without defering work to the workqueue.
	 * Avoiding the workqueue when possible improves the latency.
	 */
